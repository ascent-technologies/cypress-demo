...
const ContentBox = ({ className, ...restProps }) => (
  <div className={className || "col-sm-5 bg-light my-2 mx-auto"} {...restProps} />
);
  ...
  return (
    <Container>
      ...
      <Row>
        <div className="bg-light mx-auto my-4">
          <div className="text-center">
            ...
            Random Hogwarts House: <code>`https://www.potterapi.com/v1/sortingHat`</code><br />
            Random Dog Photo Src: <code>`https://dog.ceo/api/breeds/image/random`</code>
            <hr style={{borderBottom: '2px dashed gray'}} />
      ...
      <Row>
        ...
        <ContentBox style={{ minHeight: "200px", borderTop: "4px solid red" }}>
        {error ? (
